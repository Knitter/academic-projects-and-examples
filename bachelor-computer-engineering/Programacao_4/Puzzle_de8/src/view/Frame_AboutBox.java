...
public class Frame_AboutBox extends JDialog implements ActionListener {
  ...
  String product = "Puzzle de 8";
  String version = "1.0";
  String copyright = "Copyright (c) 2005";
  String comments = "Implementa\u00e7\u00e3o do puzzle de 8 - ficha 2";
  ...
  private void jbInit() throws Exception  {
    image1 = new ImageIcon(view.Frame.class.getResource("/config/imagens/about.png"));
