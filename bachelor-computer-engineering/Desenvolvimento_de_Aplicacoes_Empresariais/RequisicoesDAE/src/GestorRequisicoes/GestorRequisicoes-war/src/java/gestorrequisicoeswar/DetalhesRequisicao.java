...
import top.domain.ejbs.ControladorLinhaRequisicaoRemote;
 ...
 */
public class DetalhesRequisicao extends AbstractPageBean {   
    ...
    @EJB ControladorLinhaRequisicaoRemote rlreq;
    ...
    private StaticText txtAssunto = new StaticText();

    public StaticText getTxtAssunto() {
        return txtAssunto;
    }

    public void setTxtAssunto(StaticText st) {
        this.txtAssunto = st;
    }
    private Label lblAssunto = new Label();

    public Label getLblAssunto() {
        return lblAssunto;
    }

    public void setLblAssunto(Label l) {
        this.lblAssunto = l;
    }
    private Label lblRemetente = new Label();

    public Label getLblRemetente() {
        return lblRemetente;
    }

    public void setLblRemetente(Label l) {
        this.lblRemetente = l;
    }
    private StaticText txtRemetenteNome = new StaticText();

    public StaticText getTxtRemetenteNome() {
        return txtRemetenteNome;
    }

    public void setTxtRemetenteNome(StaticText st) {
        this.txtRemetenteNome = st;
    }
    private StaticText txtRemetenteApelido = new StaticText();

    public StaticText getTxtRemetenteApelido() {
        return txtRemetenteApelido;
    }

    public void setTxtRemetenteApelido(StaticText st) {
        this.txtRemetenteApelido = st;
    }
