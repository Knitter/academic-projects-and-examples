...
cmdline_parser_print_help (void)
{
  ...
  printf("\n"
  "Purpose:\n"
  "  facilitar tratamento de argumentos do psschedule\n"
  "\n"
  "Usage: %s [OPTIONS]...\n", PACKAGE);
  printf("   -h      --help      Print help and exit\n");
  printf("   -V      --version   Print version and exit\n");
  printf("   -fINT   --freq=INT  frequencia de actualizacao\n");
}
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* frequencia de actualizacao.  */
          ...
          args_info->freq_arg = atoi (optarg);
          break;
