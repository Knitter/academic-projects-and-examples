...
public class MainFrame_AboutBox extends JDialog implements ActionListener {
    ...
    String product = "Base de Dados Estudantil";
    String version = "1.02";
    String copyright = "Copyright (c) 2005";
    String comments = "3ª Fase do Trabalho de Base de Dados II";
    ...
    private void jbInit() throws Exception {
        image1 = new ImageIcon(bdestudantil.MainFrame.class.getResource("resources/images/hat.PNG"));
