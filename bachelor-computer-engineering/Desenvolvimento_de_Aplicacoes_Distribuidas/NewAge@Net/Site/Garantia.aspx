<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Garantia.aspx.cs" Inherits="Tickets" Title="NewAge@Net - Garantia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Panel ID="Panel1" runat="server" Height="11px" HorizontalAlign="Left" Width="95%">
