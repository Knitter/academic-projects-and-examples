<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Suporte.aspx.cs" Inherits="Suporte" Title="NewAge@Net - Suporte" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Panel ID="Panel1" runat="server" Height="12px" HorizontalAlign="Left" Width="95%">
