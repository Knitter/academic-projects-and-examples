<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Empresa.aspx.cs" Inherits="Tickets" Title="NewAge@Net - Empresa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Panel ID="Panel1" runat="server" Height="14px" HorizontalAlign="Left" Width="95%">
