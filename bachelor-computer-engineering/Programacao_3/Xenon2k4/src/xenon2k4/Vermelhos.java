...
public final class Vermelhos extends Vermelho {

  private GrupoVermelhos grupo;
  									
  /*Construtores*/
  public Vermelhos(String nome, TileSet imagens, Movimento movimento, int hitPoints, int energia, long tempoActual, int pontuacao, GrupoVermelhos grupo, Nivel nivel) {
