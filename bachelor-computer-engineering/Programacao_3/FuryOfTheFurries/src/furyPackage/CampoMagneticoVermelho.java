 ...
 * <p><b>Description:</b> Campo Magnético Vermelho
 * <p><b>Copyright:</b> Copyright (c) 2005
 * <p><b>Company:</b> 4thFloor Corporation
 * @author Sérgio Lopes<br>Ruben Pedro
 * @version 5.0
 */
public final class CampoMagneticoVermelho extends CampoMagnetico {
    ...
    public CampoMagneticoVermelho(String nome, Ponto posicao, Nivel nivel, long tempo, Habilidade habilidade) {
        ...
        getSprite().adicionarAnimacao(PARADO, new AnimacaoSprite(nivel.getImagem("campoMagnetico"), new int[] {}, new int[] {5,6}, new int[] {}, 0, 500, 0));
    ...
    public void alterarDisponibilidade(Tiny heroi, long tempo) {
        ...
        heroi.corrigirHabilidadeActual(Habilidade.MARTELO, tempo);
    }
